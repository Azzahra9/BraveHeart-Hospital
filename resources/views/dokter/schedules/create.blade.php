    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="mb-6 border-b border-gray-100 pb-4">
                <h3 class="text-lg font-bold text-gray-900">Buat Jadwal Baru</h3>
                <p class="text-sm text-gray-500">Tentukan hari dan jam praktik Anda.</p>
            </div>

            <form method="POST" action="{{ route('dokter.schedules.store') }}">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_mulai" class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-red-200 transition shadow-sm" required>
                        <p class="text-xs text-gray-400 mt-1">Format 24 Jam (Contoh: 09:00)</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="durasi" value="30" min="15" max="120" class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-red-200 transition shadow-sm pr-12" required>
