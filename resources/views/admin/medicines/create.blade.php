    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="mb-6 border-b border-gray-100 pb-4">
                <h3 class="text-lg font-bold text-gray-900">Detail Obat</h3>
                <p class="text-sm text-gray-500">Masukkan informasi lengkap mengenai obat baru.</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.medicines.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3" 
                              class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-red-200 transition shadow-sm" 
                              placeholder="Kegunaan obat..." required>{{ old('deskripsi') }}</textarea>
                </div>

                <!-- Upload Gambar -->
                <div class="mb-8">
                    <label for="gambar" class="block text-sm font-bold text-gray-700 mb-1">Foto Obat (Opsional)</label>
