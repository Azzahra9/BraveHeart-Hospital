<nav x-data="{ open: false }" class="fixed top-0 w-full z-50 pt-6 px-4 sm:px-6 lg:px-8 pointer-events-none">
    ...
    <!-- Responsive Navigation Menu (Melayang di bawah Kapsul) -->
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden mt-2 pointer-events-auto transition-all duration-200 origin-top">
        <!-- Container menu mobile dibuat kotak terpisah dengan sudut rounded agar rapi -->
